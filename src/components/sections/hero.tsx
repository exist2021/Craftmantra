      ...
      <div className="container px-4 md:px-6">
        <div className="flex flex-col items-center space-y-4 text-center">
          <div className="space-y-6">
            ...
            <div className="max-w-[800px] mx-auto text-muted-foreground md:text-lg font-body space-y-4">
              <p>
            ...
            <Tabs defaultValue="vision" className="w-full">
              ...
              <TabsContent value="vision">
                <div className="p-6 pt-8 bg-background/50 rounded-b-lg rounded-tr-lg text-center space-y-4">
                  ...
                  <p className="text-lg font-body text-muted-foreground">{vision}</p>
                </div>
              </TabsContent>
              <TabsContent value="mission">
                 <div className="p-6 pt-8 bg-background/50 rounded-b-lg rounded-tl-lg text-center space-y-4">
                  ...
                  <p className="text-lg font-body text-muted-foreground">{mission}</p>
                </div>
              </TabsContent>
            </Tabs>
          </div>
